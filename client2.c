...
int main(int argc, char **argv) {
    ...
    server_addr.sin_addr.s_addr = inet_addr("34.227.22.211"); // Cambiar la dirección IP por la de tu instancia EC2
    ...
    if (recvfrom(sockfd, buffer, sizeof(buffer), 0, (struct sockaddr *)&server_addr, &addr_size) == SOCKET_ERROR) {
